...
//		System.out.print((byte) ' ');
		topDataAnalyze(top1UniqueTag, getDataFromTop(Top1), 1, 2);
		topDataAnalyze(top2UniqueTag, top2TableTag, getDataFromTop(Top2), 2, 3);
		topDataAnalyze(top3UniqueTag, top3TableTag, getDataFromTop(Top3), 2, 3);
		topDataAnalyze(top4UniqueTag, top4TableTag, getDataFromTop(Top4), 1, 2);
	}
